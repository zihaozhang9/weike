...
//			this.setLayout(null);						//设置窗口布局管理器
			...
			JTA1.setBounds(110,5,300,100);		//设置姓名标签的初始位置
			this.add(JTA1);						//将姓名标签组件添加到容器
			JP.add(JTA1);	
			JTA2.setBounds(110,150,300,100);			//设置文本框的初始位置
			this.add(JTA2);						//将文本框组件添加到容器
			JP.add(JTA2);
			JTA3.setBounds(5,110,130,20);			//设置文本框的初始位置
			this.add(JTA3);						//将文本框组件添加到容器
			JP.add(JTA3);
			...
			JB3.setBounds(400,110,80,20);				//设置密码标签的初始位置
